...
public final class ParameterRotationType {
	...
	private static ParameterRotationType[] swigValues = { 
			ParameterRotationType_Fixed, 
			ParameterRotationType_PVA, 
			ParameterRotationType_Easing,
			ParameterRotationType_AxisPVA, 
			ParameterRotationType_AxisEasing, 
			ParameterRotationType_FCurve, 
			ParameterRotationType_None,
			ParameterRotationType_DWORD 
	};
